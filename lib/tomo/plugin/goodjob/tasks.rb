module Tomo::Plugin::Goodjob
  class Tasks < Tomo::TaskLibrary
    ...
    def service
      SystemdUnit.new(
        settings[:goodjob_systemd_service],
        paths.goodjob_systemd_service_template,
        paths.goodjob_systemd_service
      )
    end
    ...
    def linger_must_be_enabled!
      ...
      die <<~ERROR.strip
        ...
        goodjob to stay running in the background via systemd. Run the following
        command as root:
